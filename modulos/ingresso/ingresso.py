...
def obtem_todos_ingressos() -> list:
    """
    Retorna uma cópia da lista de todos os ingressos cadastrados.
    Útil para debug, relatórios e para garantir imutabilidade externa.
    """
